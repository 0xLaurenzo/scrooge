import{i as N,f as k,x as a,r as L,z as v,aq as p,D as O,R as Y,ar as z,y as V,A as E,W}from"./CQiRH5sv.js";import{n as l,c as _,o as j,r as b}from"./DZoNvPrZ.js";import{T as A,D as F}from"./I8ryY87Q.js";import"./BowwM8Xu.js";import"./CQuLVgNe.js";import"./mrxuGU4B.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
