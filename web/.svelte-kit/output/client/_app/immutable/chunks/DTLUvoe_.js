import{i as T,f as w,x as c,aE as J,aK as l,aq as N,aD as x,A as S,ar as j,M as I,z as O,Q as Z,y as G,W as H,R as B,D as K,J as M,B as Q,v as ee,u as L,T as te}from"./CQiRH5sv.js";import{n as d,c as g,o as h,r as u}from"./DZoNvPrZ.js";import{D as ie,T as re}from"./I8ryY87Q.js";import"./BowwM8Xu.js";import"./mrxuGU4B.js";import"./CFljRYqt.js";import"./BJ706Cpd.js";import{O as z}from"./DC6DblS2.js";import"./CPxVPybI.js";import"./CQuLVgNe.js";import"./BZybav6A.js";import"./BSvI1CRX.js";import"./CdrdKq2l.js";const oe=T`
  :host {
    width: 100%;
  }
...
`;var U=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};const ne=7;let A=class extends w{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=l.state.selectedProvider,this.loading=!1,this.coinbaseTransactions=N.state.coinbaseTransactions,this.tokenImages=x.state.tokenImages,this.unsubscribe.push(l.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}),x.subscribeKey("tokenImages",e=>this.tokenImages=e),()=>{clearTimeout(this.refetchTimeout)},N.subscribe(e=>{this.coinbaseTransactions={...e.coinbaseTransactions}})),N.clearCursor(),this.fetchTransactions()}render(){return c`
      <wui-flex flexDirection="column" .padding=${["0","s","s","s"]} gap="xs">
        ${this.loading?this.templateLoading():this.templateTransactionsByYear()}
      </wui-flex>
    `}templateTransactions(e){return e==null?void 0:e.map(t=>{var n,D,F;const r=ie.formatDate((n=t==null?void 0:t.metadata)==null?void 0:n.minedAt),o=t.transfers[0],i=o==null?void 0:o.fungible_info;if(!i)return null;const s=((D=i==null?void 0:i.icon)==null?void 0:D.url)||((F=this.tokenImages)==null?void 0:F[i.symbol||""]);return c`
        <w3m-onramp-activity-item
          ...
          symbol=${h(i.symbol)}
        ></w3m-onramp-activity-item>
      `})}templateTransactionsByYear(){return Object.keys(this.coinbaseTransactions).sort().reverse().map(t=>{const r=parseInt(t,10);return new Array(12).fill(null).map((i,s)=>s).reverse().map(i=>{var D;const s=re.getTransactionGroupTitle(r,i),n=(D=this.coinbaseTransactions[r])==null?void 0:D[i];return n?c`
...
`;var ue=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let V=class extends w{render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=j.state;return!e&&!t?null:c`
      <wui-flex
        .padding=${["m","s","s","s"]}
        flexDirection="column"
        alignItems="center"
    ...
    `}howDoesItWorkTemplate(){return c` <wui-link @click=${this.onWhatIsBuy.bind(this)}>
      ...
      How does it work?
    </wui-link>`}onWhatIsBuy(){var t;const e=O.state.activeChain;G.sendEvent({type:"track",event:"SELECT_WHAT_IS_A_BUY",properties:{isSmartAccount:((t=S.state.preferredAccountTypes)==null?void 0:t[e])===H.ACCOUNT_TYPES.SMART_ACCOUNT}}),B.push("WhatIsABuy")}};V.styles=[le];V=ue([g("w3m-onramp-providers-footer")],V);var X=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let Y=class extends w{constructor(){super(),this.unsubscribe=[],this.providers=l.state.providers,this.unsubscribe.push(l.subscribeKey("providers",e=>{this.providers=e}))}firstUpdated(){const e=this.providers.map(async t=>t.name==="coinbase"?await this.getCoinbaseOnRampURL():Promise.resolve(t==null?void 0:t.url));Promise.all(e).then(t=>{this.providers=this.providers.map((r,o)=>({...r,url:t[o]||""}))})}render(){return c`
      <wui-flex flexDirection="column" .padding=${["0","s","s","s"]} gap="xs">
