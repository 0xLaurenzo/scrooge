import{i as E,f as L,L as S,ar as b,R as g,J as W,x as l,D as C,as as D,G as F,A as d,C as j,z as _,y as u,v as T,V as U,u as y,at as q,M as I,T as P}from"./CQiRH5sv.js";import{n as z,r as c,c as k,o as v}from"./DZoNvPrZ.js";import{O as R}from"./DC6DblS2.js";import{e as M}from"./Bx_La0gs.js";import"./BowwM8Xu.js";import"./BSvI1CRX.js";import"./BZybav6A.js";import"./CQuLVgNe.js";import"./CpyJZi8s.js";import"./Drlge1ho.js";const V=E`
  :host {
...
`;var w=function(a,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(a,e,i,o);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let h=class extends L{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=S.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=b.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(S.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(i=>i.type==="AUTH")}),b.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var t;let e=((t=this.remoteFeatures)==null?void 0:t.socials)||[];const i=!!this.authConnector,o=e==null?void 0:e.length,n=g.state.view==="ConnectSocials";return(!i||!o)&&!n?null:(n&&!o&&(e=W.DEFAULT_SOCIALS),l` <wui-flex flexDirection="column" gap="xs">
      ${e.map(r=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await M(e)}async handlePwaFrameLoad(){var e;if(C.isPWA()){this.isPwaLoading=!0;try{((e=this.authConnector)==null?void 0:e.provider)instanceof D&&await this.authConnector.provider.init()}catch(i){F.open({shortMessage:"Error loading embedded wallet in PWA",longMessage:i.message},"error")}finally{this.isPwaLoading=!1}}}};h.styles=V;w([z()],h.prototype,"tabIdx",void 0);w([c()],h.prototype,"connectors",void 0);w([c()],h.prototype,"authConnector",void 0);w([c()],h.prototype,"remoteFeatures",void 0);w([c()],h.prototype,"isPwaLoading",void 0);h=w([k("w3m-social-login-list")],h);const G=E`
  wui-flex {
...
`;var A=function(a,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(a,e,i,o);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let $=class extends L{constructor(){super(),this.unsubscribe=[],this.checked=R.state.isLegalCheckboxChecked,this.unsubscribe.push(R.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var O;const{termsConditionsUrl:e,privacyPolicyUrl:i}=b.state,o=(O=b.state.features)==null?void 0:O.legalCheckbox,t=!!(e||i)&&!!o,r=t&&!this.checked,s=r?-1:void 0;return l`
    ...
    `}};$.styles=G;A([c()],$.prototype,"checked",void 0);$=A([k("w3m-connect-socials-view")],$);const N=E`
  wui-logo {
    width: 80px;
    height: 80px;
